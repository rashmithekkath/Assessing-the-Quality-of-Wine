...
#library(klaR)
#split=0.80
#trainIndex=Number<4000
#data_train <- qual[ 1:4000,]
#data_test <- qual[4000:4898,]
#x_test <- data_test[,4000:4898]
#y_test <- data_test[,4000:4898]
...
#predictions <- predict(glm.fits2, x_test)
#confusionMatrix(predictions$class, y_test)

#glm.probs=predict(glm.fits,newdata=quality.4000, type="response")
#confusionMatrix(predictions$class, y_test)

#glm.pred=rep("Less Acidic",2000)
#glm.pred[glm.probs<6.1]="More Acidic"
#table(glm.pred,quality)

#mean(glm.pred==quality)
```
